...
async def _handle_no_results(client: Client, message: Message, status,
    ...
    """Show IMDb/TMDB suggestions when DB returns 0 hits."""
    try:
...
# ═══════════════════════ EPISODES ═══════════════════════
async def _show_episodes(target, sid: str, season: int, eps: List[int],
